        ...
        if(($pdf_file != "" and $pdfFileType != "pdf") or ($html_file != "" and $htmlFileType != "htm" and $htmlFileType != "html" )) {
            ...
            if($rez1 == 1 && $rez2 == 1) {
                ...
                if(!isset($_SESSION["flajerRed"])) {
                    ...
                    if ($rez == 1) {
                        echo '<script>alert("Uspešno ažuriranje flajera!");window.location.href=("../../administrator/unesiFlajerAdmin.html")</script>';
                    } else {
                        echo '<script>alert("Neuspešno ažuriranje flajera, pokušajte opet!");window.location.href=("../../administrator/unesiFlajerAdmin.html")</script>';
                    }
                }
            } else {
